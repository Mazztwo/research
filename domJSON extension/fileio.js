...
var jsonOutput = domJSON.toJSON(document.documentElement); //what to put as a parameter? website uses elements or nodes as examples

//now do something with the JSON message
